...
### v5.3.0 (엑셀·이미지 가져오기 활성화 완료) — 2026-08-25 07:27

| 순번 | 변경 내용 | 변경자 |
|---|---|---|
| 005 | `import.js` 파싱 구문 오류(SyntaxError) 수정 및 메뉴 활성화 완료 | AI |
| 006 | 대시보드 상단 버전 배너 및 사이드바 버전/업데이트 일시(2026-08-25 07:27) 반영 | AI |
